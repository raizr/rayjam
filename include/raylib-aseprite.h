 ...
 * @see LoadAseprite()
 */
static Aseprite LoadAsepriteFromMemory(unsigned char* fileData, unsigned int size) {
    ...
    Texture2D* texturePointer = static_cast<Texture2D*>(ase->mem_ctx);
 ...
 * @see IsAsepriteReady()
 */
static Aseprite LoadAseprite(const char* fileName) {
    int bytesRead;
 ...
 */
static bool IsAsepriteReady(Aseprite aseprite) {
 ...
 */
static Texture GetAsepriteTexture(Aseprite aseprite) {
    if (aseprite.ase == 0) {
 ...
 */
static int GetAsepriteWidth(Aseprite aseprite) {
    if (aseprite.ase == 0) {
 ...
 */
static int GetAsepriteHeight(Aseprite aseprite) {
    if (aseprite.ase == 0) {
        TraceLog(LOG_WARNING, "ASEPRITE: Cannot get width from non-existant aseprite");
        return 0;
    }
 ...
 */
static int GetAsepriteTagCount(Aseprite aseprite) {
    if (aseprite.ase == 0) {
 ...
 * @see LoadAseprite()
 */
static void UnloadAseprite(Aseprite aseprite) {
 ...
 */
static void TraceAseprite(Aseprite aseprite) {
    ase_t* ase = aseprite.ase;
    if (ase == 0) {
 ...
 */
static void UpdateAsepriteTag(AsepriteTag* tag) {
 ...
 */
static AsepriteTag GenAsepriteTagDefault() {
 ...
 */
static AsepriteTag LoadAsepriteTagFromIndex(Aseprite aseprite, int index) {
 ...
 */
static AsepriteTag LoadAsepriteTag(Aseprite aseprite, const char* name) {
    AsepriteTag tag = GenAsepriteTagDefault();
    ase_t* ase = aseprite.ase;
    if (ase == 0) {
 ...
 */
static bool IsAsepriteTagReady(AsepriteTag tag) {
    return tag.tag != 0;
}
 ...
 */
static AsepriteSlice LoadAsepriteSlice(Aseprite aseprite, const char* name) {
 ...
 * @return The loaded slice, or an empty one if not found.
 */
static AsepriteSlice LoadAsperiteSliceFromIndex(Aseprite aseprite, int index) {
    if (aseprite.ase == NULL) {
 ...
 */
static AsepriteSlice GenAsepriteSliceDefault() {
    AsepriteSlice slice;
    slice.name = {};
 ...
 */
static int GetAsepriteSliceCount(Aseprite aseprite) {
 ...
 */
static bool IsAsepriteSliceReady(AsepriteSlice slice) {
